<%@ Page Language="C#" MasterPageFile="~/HOME/HOMEMASTER.Master" AutoEventWireup="true" CodeBehind="Admin_Forgetpwd.aspx.cs" Inherits="RTOSYSTEM.HOME.WebForm6" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
<br />
<table align="center" 
        style="font-weight: bold; font-size: x-large; border-style: groove; height: 245px;"   class="transbox">
   <tr>
        <td align="center" style="font-weight: bold" colspan="2">
            <asp:Label ID="Label1" runat="server" Text="ADMIN FORGET PASSWORD" 
