<%@ Page Language="C#" MasterPageFile="~/HOME/HOMEMASTER.Master" AutoEventWireup="true" CodeBehind="Admin_Registration.aspx.cs" Inherits="RTOSYSTEM.HOME.WebForm5" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
<br />
<table align="center" 
        style="border-style: groove; font-weight: bold; font-size: large; color: #FFFFFF;"  class="transbox">
    <tr>
            <td align="center" style="font-size: large; font-weight: bold" colspan="2">
                <asp:Label ID="lbladmin_registration" runat="server" Text="ADMIN REGISTRATION"></asp:Label>
            </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="lblaid" runat="server" Text="Admin Id"></asp:Label>
        </td>
        <td>
            <asp:TextBox ID="txtaid" runat="server" Width="222px" CssClass="txtfname" 
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtaddress" runat="server" Width="222px" TextMode="MultiLine" CssClass="txtfname"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtpwd" runat="server" Width="222px" TextMode="Password" CssClass="txtfname"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtretypepwd" runat="server" Width="222px" CssClass="txtfname"></asp:TextBox>
    ...
    <tr>
        <td align="center" colspan="2">
            <asp:Button ID="btnsubmit" runat="server" Text="Submit" 
                onclick="btnsubmit_Click" Font-Bold="True" Width="69px" 
                CssClass="button" />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="txtclear" runat="server" Text="Clear" Font-Bold="True" 
                onclick="txtclear_Click" Width="58px" CssClass="button" />
        </td>
    </tr>
    <tr>
        <td colspan="2">
